...
export const toggleOrderBy = (columnName) => (dispatch) => {
  // This method is triggered from table head and it instantly loads new data
  dispatch({
    type: TOGGLE_ORDER,
    columnName,
  });
...
export const toggleColumnSelection = (columnName) => (dispatch) =>
  dispatch({
    type: TOGGLE_COLUMN_SELECTION,
    columnName,
  });

export const initiateFilter = (columnName, dataType) => (dispatch) =>
  dispatch({
...
export const setFilter = (columnName, filters) => (dispatch) =>
  dispatch({
...
export const removeFilter = (columnName) => (dispatch) =>
  dispatch({
